...
Alert.alert('Payment succes')
    ...
    return (
        <View style={[items.lang.currentLocal.language == 'ar' && { direction: 'rtl' }, styles.container]}>
            <Header
                title={items.lang.currentLocal.settings && items.lang.currentLocal.settings.approvedCampaigns}
                />
                    ...
                    return (<View style={styles.campainContainer}>
                        ...
                        <View style={styles.btnContainer}>
                            <TouchableOpacity style={styles.btn} onPress={()=>HanddlePayment(item.id)}>
                                <Text style={styles.btnText}>{items.lang.currentLocal.settings.Payment}</Text>
                            </TouchableOpacity>
...
export default ApprovedCampainsScreen
