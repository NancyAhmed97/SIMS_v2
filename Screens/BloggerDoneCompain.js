...
const BloggerDoneCompain = () => {
    ...
    useEffect(() => {
        ...
        const getdata = () => {
            axios.get(`${base_url}/api/bloger/done-campaign?blogerId=${items.authorization.userInfo.userOrBloger.id}`,
                {
                    headers: {
...
export default BloggerDoneCompain
