...
const BloggerRejectedCompain = () => {
    ...
    useEffect(() => {
        ...
        const getdata = () => {
            axios.get(`http://92.113.26.138:8081/api/bloger/rejected-campaign?blogerId=${items.authorization.userInfo.userOrBloger.id}`,
                {
                    headers: {
...
export default BloggerRejectedCompain
